...
export function FormSelect({
  ...
  return (
    <div className="space-y-2">
      {label ? (
        <label htmlFor={selectId} className="flex items-center gap-1 text-sm font-medium text-white">
          {label}
      ...
      <select
        id={selectId}
        name={name}
        className={`touch-target w-full rounded-xl border transition-all duration-[var(--motion-fast)] appearance-none
          ...
          px-4 py-3 text-white outline-none pr-10 cursor-pointer
